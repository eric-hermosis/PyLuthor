...
\begin{figure}[h]
\centering
\includegraphics{assets/entropy_plot_en.pdf}
\caption{Expected value of information}
\label{figure:entropy_plot_en}
\end{figure}

$\langle I \rangle$ in units of $k$ as a function of the probability $p$ of event occurrence.

Figure \ref{figure:entropy_plot_en} shows that the expected value of information is symmetric with respect to $p = 1/2$, where entropy reaches its maximum. This reflects that uncertainty is highest when both outcomes are equally likely. At the extremes, the expected information tends to zero, indicating that when the outcome is practically certain, the information provided is minimal.
...
\begin{figure}[h]
\centering
\includegraphics{assets/probability_plot_en.pdf}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics{assets/sigmoid_temperature_sweep_en.pdf}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics{assets/swish_to_relu_thermal_limit_en.pdf}
\end{figure}
...
\subsubsection{Excitation–Inhibition}
...
\begin{figure}[h]
\centering
\includegraphics{assets/two_level_probabilities_en.pdf}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics{assets/entropy_comparison_en.pdf}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics{assets/tanh_activation_en.pdf}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics{assets/tanh_temperature_sweep_en.pdf}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics{assets/synaptic_suppression_threshold_en.pdf}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics{assets/synaptic_suppression_property_en.pdf}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics{assets/suppressed_tanh_activation_sweep_en.pdf}
\end{figure}
